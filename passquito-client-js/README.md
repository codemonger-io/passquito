...
```sh
npm install @codemonger-io/passquito-client-js@0.0.4-abc1234
```

Please replace `0.0.4-abc1234` with the actual version number of the _snapshot_ you want to install, which is available in the [package repository](https://github.com/codemonger-io/passquito/pkgs/npm/passquito-client-js).
